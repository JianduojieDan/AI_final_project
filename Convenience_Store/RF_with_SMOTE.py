...
print(f"Resampled training dataset shape: {pd.Series(y_train_resampled).value_counts()}")

print(f"Resampled training dataset size: {len(X_train_resampled)} | testing dataset size: {len(X_test)}")
print("\n start basic RF")
print("WAIT...")
